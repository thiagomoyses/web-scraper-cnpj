...
class WebScrapper:
    ...
    def get_cnpj_and_infos(self, page):
        ...
        request = requests.post(self.base_url, data=body, headers=self.headers)
        ...
        get_html_info = self.__get_companies_information(cnpj_list, body)

        filtered_informations = self.__filter_informations(get_html_info)

        return filtered_informations

    def __get_companies_information(self, cnpj_list, body):
        ...
        for company_url in url_list:
            request = requests.get(company_url, data=body, headers=self.headers)
    ...
    def __filter_informations(self, html_array):
        ...
        for elements in html_array:
            ...
            white_list = {"CNPJ": "", "Razão Social": "", "E-MAIL": "", "Telefone": ""}
